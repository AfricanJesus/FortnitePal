...
public class ChallengeSetDataLoader implements CommandLineRunner {
    ...
    private String challengeUrl = "https://s3.us-east-2.amazonaws.com/fortnitepal/images/challenge";
    ...
    public void run(String... args){
        ...
        challenges.add(new Challenge("Reach Season Level 10", "Carbide Chest", challengeUrl + "/carbide-chest.png"));
        challenges.add(new Challenge("Reach Season Level 20", "Carbide Legs", challengeUrl + "/carbide-legs.png"));
        challenges.add(new Challenge("Reach Season Level 30", "Carbide Arms", challengeUrl + "/carbide-arms.png"));
        challenges.add(new Challenge("Reach Season Level 40", "Carbide Head", challengeUrl + "/carbide-head.png"));
        challenges.add(new Challenge("Reach Season Level 65", "Carbide Accents", challengeUrl + "/carbide-chest-2.png"));
        ...
        challenges = new ArrayList<>();
        challenges.add(new Challenge("Gain 10,000 XP", "Stage 1", challengeUrl + "/drift-stage-1.png"));
        challenges.add(new Challenge("Gain 25,000 XP", "Stage 2", challengeUrl + "/drift-stage-2.png"));
        challenges.add(new Challenge("Gain 50,000 XP", "Stage 3", challengeUrl + "/drift-stage-3.png"));
        challenges.add(new Challenge("Gain 100,000 XP", "Stage 4", challengeUrl + "/drift-stage-4.png"));
        challenges.add(new Challenge("Gain 200,000 XP", "Stage 5", challengeUrl + "/drift-stage-5.png"));
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
        ...
        challenges = new ArrayList<>();
        challenges.add(new Challenge("Reach Season Level 25", "Omega Chest", challengeUrl + "/omega-chest.png"));
        challenges.add(new Challenge("Reach Season Level 35", "Omega Legs", challengeUrl + "/omega-legs.png"));
        challenges.add(new Challenge("Reach Season Level 45", "Omega Arms", challengeUrl + "/omega-arms.png"));
        challenges.add(new Challenge("Reach Season Level 55", "Omega Mask", challengeUrl + "/omega-mask.png"));
        challenges.add(new Challenge("Reach Season Level 80", "Omega Accent", challengeUrl + "/omega-accent.png"));
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
        ...
        challenges = new ArrayList<>();
        challenges.add(new Challenge("Gain 35,000 XP", "Stage 1", challengeUrl + "/ragnarok-stage-1.png"));
        challenges.add(new Challenge("Gain 75,000 XP", "Stage 2", challengeUrl + "/ragnarok-stage-2.png"));
        challenges.add(new Challenge("Gain 120,000 XP", "Stage 3", challengeUrl + "/ragnarok-stage-3.png"));
        challenges.add(new Challenge("Gain 250,000 XP", "Stage 4", challengeUrl + "/ragnarok-stage-4.png"));
        challenges.add(new Challenge("Gain 500,000 XP", "Stage 5", challengeUrl + "/ragnarok-stage-5.png"));
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
        ...
        challenges = new ArrayList<>();
        challenges.add(new Challenge("Gain 20,000 XP", "Stage 1", challengeUrl + "/calamity-stage-1.png"));
        challenges.add(new Challenge("Gain 50,000 XP", "Stage 2", challengeUrl + "/calamity-stage-2.png"));
        challenges.add(new Challenge("Gain 90,000 XP", "Stage 3", challengeUrl + "/calamity-stage-3.png"));
        challenges.add(new Challenge("Gain 140,000 XP", "Stage 4", challengeUrl + "/calamity-stage-4.png"));
        challenges.add(new Challenge("Gain 200,000 XP", "Stage 5", challengeUrl + "/calamity-stage-5.png"));
        challenges.add(new Challenge("Complete 10 Weekly Challenges", "Color (TEAL)",challengeUrl + "/calamity-color-teal.png"));
        challenges.add(new Challenge("Complete 25 Weekly Challenges", "Color (PURPLE)",challengeUrl + "/calamity-color-purple.png"));
        challenges.add(new Challenge("Complete 50 Weekly Challenges", "Color (BLACK)",challengeUrl + "/calamity-color-black.png"));
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
        ...
        challenges = new ArrayList<>();
        challenges.add(new Challenge("Gain 30,000 XP","Stage (Half-Wolf)",challengeUrl + "/dire-half-wolf.png"));
        challenges.add(new Challenge("Gain 70,000 XP", "Stage (Brown Werewolf)",challengeUrl + "/dire-brown-werewolf.png"));
        challenges.add(new Challenge("Gain 120,000 XP", "Stage (Grey Werewolf)",challengeUrl + "/dire-grey-werewolf.png"));
        challenges.add(new Challenge("Gain 180,000 XP", "Stage (White Werewolf)",challengeUrl + "/dire-white-werewolf.png"));
        challenges.add(new Challenge("Gain 250,000 XP", "Stage (Black Werewolf)",challengeUrl + "/dire-black-werewolf.png"));
        challenges.add(new Challenge("Complete 20 Weekly Challenges", "Color (BLUE)",challengeUrl + "/dire-color-blue.png"));
        challenges.add(new Challenge("Complete 40 Weekly Challenges", "Color (YELLOW)",challengeUrl + "/dire-color-yellow.png"));
        challenges.add(new Challenge("Complete 60 Weekly Challenges", "Color (BROWN)",challengeUrl + "/dire-color-brown.png"));
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
        ...
        challengeSet.setChallengeSetRewardImage(challengeUrl + "/images/spray/solo-showdown.png");
        challenges = new ArrayList<>();
        challengeSet.setChallenges(challenges);
        saveChallengeSet(challengeSet);
    ...
    private boolean hasDuplicate(ChallengeSet set){
